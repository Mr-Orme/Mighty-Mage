...
ObjectFactory::GAME_OBJECT_STATS  ObjectAssetLibrary::Search(std::string name)
//**************************************
{
...
bool ObjectAssetLibrary::AddAsset(std::string name, ObjectFactory::GAME_OBJECT_STATS stats)
//**************************************
{
	library[name] = stats;
	return true;
